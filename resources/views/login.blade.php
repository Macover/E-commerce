                                ...
                                <form class="user" action="{{route('login.form')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                               id="exampleInputPassword" placeholder="Ingresa tu contraseña" name="password" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" value="Iniciar" class="btn btn-outline-info btn-user btn-block">
                                    <hr>
                                    @if(isset($_GET["r"]))
