                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="{{route('registro.form')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user"
                                           id="exampleRepeatPassword" placeholder="Repite Contraseña" name="password2">
                                </div>
                            </div>
                            <input type="submit" class="btn btn-outline-info btn-user btn-block" value="Crear Cuenta">
                            <hr>
                        </form>
                        <hr>
                        <div class="text-center">
